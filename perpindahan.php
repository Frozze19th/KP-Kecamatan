...
<html>
  ...
  <!-- NAVBAR -->
   <nav class="navbar sticky-top navbar-dark bg-primary navbar-expand-md">
    ...
    <!-- /NAVBAR -->
   <div class="container">
            <h2>Proses Pengajuan Surat Perpindahan Penduduk</h2>
            <br>
            <ol>
                <h4><li>
                    Meminta surat pengantar keteranagan pindah dari desa
                </h4></li>
                <h4><li>
                    Membawa surat pengantar keteranagan pindah dari desa
                </h4></li>
                <h4><li>
                    Proses pembuatan surat Keterangan pindah
                </h4></li>
                <h4><li>
                    Menunggu legaslisasi
                </h4></li>
                <h4><li>
                    Mengambil surat di Kantor Kecamatan
                </h4></li>
                <h4><li>
                    Jika perpindahan penduduk antar kabupaten atau provinsi proses selanjutnya surat di DISDUK CAPIL Kabupaten
                </h4></li>
            </ol>
   </div>
  <!-- FOOTER -->
    <footer class="footer fixed-bottom bg-primary text-center">
    <!-- Copyright -->
      <div class="container">
