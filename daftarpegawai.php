...
<html>
  ...
  <!-- NAVBAR -->
   ...
   <!-- /NAVBAR -->
    <div class="container">
        <h1 class="text-center">Daftar Pegawai Kantor Camat Pecalungan</h1>
        <br>
        <br>
        <div class="row justify-content-md-center">
            <div class="col-md-auto">
            <h3 class="text-center">Camat</h3>
            <h4>Edy Widodo, SH., M.Si.</h4>
            </div>
        </div>
        <br>
        <div class="row justify-content-md-center">
            <div class="col-md-auto">
            <h3 class="text-center">Sekcam</h3>
            <h4>Muh. Saifudin, S.IP.</h4>
            </div>
        </div>
        <br>
        <div class="row justify-content-md-center">
            <div class="col-md-auto">
                <h3 class="text-center">KASI Pemerintahan</h3>
                <p>-</p>
            </div>
            <div class="col-md-auto">
                <h3 class="text-center">KASI PMKS</h3>
                <h4>Surono Darmanto, S.IP.</h4>
            </div>
            <div class="col-md-auto">
                <h3 class="text-center">KASI TRANTIB</h3>
                <h4>Roy Etmond Lekatompessy, S.Pd.</h4>
            </div>
            <div class="col-md-auto">
                <h3 class="text-center">KASI YANUM</h3>
                <h4>Slamet Riyadi, S.Sos.</h4>
            </div>
        </div>
        <br>
        <div class="row justify-content-md-center">
            <div class="col-md-auto">
                <h3 class="text-center">KASUBAG KEU & Penyusunan Program</h3>
                <h4>Bambang Setiyono</h4>
            </div>
            <div class="col-md-auto">
            </div>
            <div class="col-md-auto">
                <h3 class="text-center">KASUBAG Umum & Kepegawaian</h3>
                <h4>Satoto, SE.</h4>
            </div>
        </div>
        <br>
        <div class="row justify-content-md-center">
            <div class="col-md-auto">
                <h3 class="text-center">Jabatan Fungsional Umum</h3>
                <ul>
                    <li>
                        <h4>Bambang Kurdioto, S.IP.</h4>
                    </li>
                    <li>
                        <h4>Ali Maksum</h4>
                    </li>
            ...
            <div class="col-md-auto">
                <h3 class="text-center">Wiyata Bakti</h3>
                <ul>
                    <li>
                        <h4>Widiyanto</h4>
                    </li>
                    <li>
                        <h4>Irawan Ambar R.</h4>
                    </li>
                    <li>
                        <h4>Idayati</h4>
                    </li>
                    <li>
                        <h4>Desty Ayu Saraswati</h4>
                    </li>
                    <li>
                        <h4>Dwi Febri Idri Astuti</h4>
                    </li>
                </ul>
            </div>
        </div>
