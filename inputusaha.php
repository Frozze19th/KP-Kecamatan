...
<html>
  ...
  <!-- NAVBAR -->
   ...
   <!-- Form -->
    <div class="container">
        <h1 class="display-4">Form Pengisian Izin Usaha</h1>
        <form method="POST" action="inputusaha.php" enctype="multipart/form-data">
            ...
            <br>
            <h5>NPWP</h5>
            <input class="input" type="text" name="npwp" placeholder="NPWP"/>
            <br>
            <h5>Alamat Pengusaha</h5>
            <input class="input" type="text" name="alamat" placeholder="Alamat Pengusaha"/>
            <br>
            <h5>Alamat Tempat Usaha</h5>
            <input class="input" type="text" name="alamat_usaha" placeholder="Alamat Tempat Usaha"/>
            <br>
            <h5>Tanggal Lahir</h5>
            <input class="input" type="date" name="tgl_lahir"/>
            <br>
            <h5>Jenis Kelamin</h5>
            <select class="selectin" name="kelamin">
                <option value="L">Laki-laki</option>
                <option value="P">Perempuan</option>
            </select>
            <br>
            <h5>Status</h5>
            <select class="selectin" name="status">
            ...
            <br>
            <h5>Pendidikan</h5>
            <select class="selectin" name="pendidikan">
            ...
            <br>
            <h5>Pekerjaan</h5>
            <input class="input" type="text" name="pekerjaan" placeholder="Pekerjaan Pengusaha"/>
            <br>
            <h5>Kode Pos</h5>
            <input class="input" type="text" name="kode_pos" placeholder="51262"/>
            <br>
            <h5>Kode Kab/Kota</h5>
            <input class="input" type="text" name="kode_kabkota" placeholder="25"/>
            <br>
            <h5>Nama Usaha</h5>
            <input class="input" type="text" name="ijin_usaha" placeholder="Nama Usaha"/>
            <br>
            <h5>Tanggal Muali Usaha</h5>
            <input class="input" type="date" name="tgl_mulai"/>
            <br>
            <h5>Jumlah Pekerja</h5>
            <input class="input" type="text" name="jumlah_pekerja" placeholder="Jumlah pekerja yang ada"/>
            <br>
            <h5>Modal Usaha</h5>
            <input class="input" type="text" name="modal" placeholder="Rp...... (isi angka saja)"/>
            <br>
            <h5>Nomor HP</h5>
            <input class="input" type="text" name="no_hp" placeholder="No HP Pengusaha"/>
            <br>
            <h5>Desa Asal</h5>
            <select class="selectin" type="text" name="desa">
        ...
        {   
            ...
            include "koneksi.php";
		    $perintah=mysqli_query($link,"Insert into pengusaha values ('$nik','$nama','$npwp','$alamat','$alamat_usaha','$tgl_lahir','$kelamin',
            '$status','$pendidikan','$pekerjaan','$kode_pos','$kode_kabkota','$ijin_usaha','$tgl_mulai', $jumlah_pekerja ,$modal,'$no_hp','$desa')");
		        //if ($perintah)
		        //{
			    //    echo "sukses";
		        //}
