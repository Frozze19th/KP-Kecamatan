...
<html>
  ...
  <!-- NAVBAR -->
   <nav class="navbar sticky-top navbar-dark bg-primary navbar-expand-md">
    ...
    <!-- /NAVBAR -->
   <div class="container">
            <h2>Proses Pengajuan Surat Keterangan Ahli Waris</h2>
            <br>
            <ol>
                <h4><li>
                    Meminta surat keterangan ahli waris dari desa
                </h4></li>
                <h4><li>
                    Membawa surat keteangan ahli waris dari desa
                </h4></li>
                <h4><li>
                    Meminta legaslisasi surat dari camat
                </h4></li>
                <h4><li>
