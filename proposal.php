...
<html>
  ...
  <!-- NAVBAR -->
   <nav class="navbar sticky-top navbar-dark bg-primary navbar-expand-md">
    ...
    <!-- /NAVBAR -->
   <div class="container">
            <h2>Proses Pengajuan Proposal</h2>
            <br>
            <ol>
                <h4><li>
                    Miminta tandatangan oleh pengurus dan kepala desa dan atau dinas instansi di bawahnya
                </h4></li>
                <h4><li>
                    Membawa proposal permohonan yang sudah di tandantangani oleh pengurus dan kepala desa atau dinas instansi di bawahnya
                </h4></li>
                <h4><li>
                    Meunggu tandatangan camat
                </h4></li>
                <h4><li>
                    Mengambil proposal di Kantor Kecamatan
                </h4></li>
            </ol>
   </div>
  <!-- FOOTER -->
