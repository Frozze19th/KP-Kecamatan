...
<html>
  ...
  <!-- NAVBAR -->
   <nav class="navbar sticky-top navbar-dark bg-primary navbar-expand-md">
    ...
    <!-- /NAVBAR -->
   <div class="container">
            <h2>Proses Pengajuan Perizinan Usaha</h2>
            <br>
            <ol>
                <h4><li>
                    Meminta Permohonan pengizinan usaha dari desa
                </h4></li>
                <h4><li>
                    Membawa permohonan pengizinan usaha, fotokopi KK, fotokopi KTP, dan NPWP(bagi yang memiliki)
                </h4></li>
                <h4><li>
                    Memiliki e-mail aktif atau dapat di buka
                </h4></li>
                <h4><li>
                    Mengisi formulir permohonan di kecamatan
                </h4></li>
                <h4><li>
                    Menunggu proses pembuatan SIUP
                </h4></li>
                <h4><li>
                    Mengambil SIUP di Kantor Kecamatan
                </h4></li>
            </ol>
   </div>
  <!-- FOOTER -->
