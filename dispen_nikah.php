...
<html>
  ...
  <!-- NAVBAR -->
   <nav class="navbar sticky-top navbar-dark bg-primary navbar-expand-md">
    ...
    <!-- /NAVBAR -->
   <div class="container">
            <h2>Proses Pengajuan Dispensasi Nikah</h2>
            <br>
            <ol>
                <h4><li>
                    Mengajukan Surat permohonan dispensasi nikah ke kecamatan
                </li></h4>
                <h4><li>
                    Menunggu surat di prosess
                </li></h4>
                <h4><li>
                    Menunggu pengajuan tandatangan Camat
                </li></h4>
                <h4><li>
                    Menunggu Penandatanganan surat oleh Camat
                </li></h4>
                <h4><li>
